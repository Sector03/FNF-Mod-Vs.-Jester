...
class PlayState extends MusicBeatState
{
	...
	var circusplatform:FlxSprite;
	var stageSeat1People:FlxSprite;
	var stageSeat2People:FlxSprite;
	var stageSeat3People:FlxSprite;
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'rehearsal':
				dialogue = CoolUtil.coolTextFile(Paths.txt('rehearsal/rehearsalDialogue'));
			case 'jester':
				dialogue = CoolUtil.coolTextFile(Paths.txt('jester/jesterDialogue'));
			case 'bell-buster':
				dialogue = CoolUtil.coolTextFile(Paths.txt('bell-buster/bell-busterDialogue'));
		}
		...
		switch(SONG.song.toLowerCase())
		{
			...
			defaultCamZoom = 0.8;
			curStage = 'circus';
			var circusbg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stageback'));
			circusbg.antialiasing = true;
			circusbg.scrollFactor.set(0.9, 0.9);
			circusbg.active = false;
			add(circusbg);

			var stageSpecs:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('specs'));
			stageSpecs.antialiasing = true;
			stageSpecs.scrollFactor.set(0.6, 0.6);
			stageSpecs.active = false;
			add(stageSpecs);

			var stageSeats3:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.image('seats3'));
			stageSeats3.setGraphicSize(Std.int(stageSeats3.width * 1));
			stageSeats3.updateHitbox();
			stageSeats3.antialiasing = true;
			stageSeats3.scrollFactor.set(0.9, 0.9);
			stageSeats3.active = false;
			add(stageSeats3);

			var stageSeats2:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.image('seats2'));
			stageSeats2.setGraphicSize(Std.int(stageSeats2.width * 1));
			stageSeats2.updateHitbox();
			stageSeats2.antialiasing = true;
			stageSeats2.scrollFactor.set(0.9, 0.9);
			stageSeats2.active = false;
			add(stageSeats2);

			var stageSeats1:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.image('seats1'));
			stageSeats1.setGraphicSize(Std.int(stageSeats1.width * 1));
			stageSeats1.updateHitbox();
			stageSeats1.antialiasing = true;
			stageSeats1.scrollFactor.set(0.9, 0.9);
			stageSeats1.active = false;
			add(stageSeats1);


			var circusplatform:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('circusplatform'));
			circusplatform.setGraphicSize(Std.int(circusplatform.width * 1));
			circusplatform.updateHitbox();
			circusplatform.antialiasing = true;
			circusplatform.scrollFactor.set(0.9, 0.9);
			circusplatform.active = false;
			add(circusplatform);
			...
			stageSeat2People = new FlxSprite(-415, -65);
			stageSeat2People.frames = Paths.getSparrowAtlas('seats2people');
			stageSeat2People.animation.addByPrefix('bop', "seat 2 bop", 24, false);
			stageSeat2People.antialiasing = true;
			stageSeat2People.scrollFactor.set(0.9, 0.9);
			stageSeat2People.updateHitbox();
			add(stageSeat2People);
			...
			stageSeat1People = new FlxSprite(-635, 285);
			stageSeat1People.frames = Paths.getSparrowAtlas('seats1people');
			stageSeat1People.animation.addByPrefix('bop', "seat 1 bop", 24, false);
			stageSeat1People.antialiasing = true;
			stageSeat1People.scrollFactor.set(0.9, 0.9);
			stageSeat1People.updateHitbox();
			add(stageSeat1People);
			...
			stageSeat3People = new FlxSprite(-415, -150);
			stageSeat3People.frames = Paths.getSparrowAtlas('seats3people');
			stageSeat3People.animation.addByPrefix('bop', "seat 3 bop", 24, false);
			stageSeat3People.antialiasing = true;
			stageSeat3People.scrollFactor.set(0.9, 0.9);
			stageSeat3People.updateHitbox();
			add(stageSeat3People);
		...
		if (curStage == 'circus-rally')
			remove(gf);
		if (curStage == 'circus-peak')
			remove(gf);
		...
		if (curSong.toLowerCase() == 'bell-buster')
		{
		healthBar.createFilledBar(0xFFFF0000, 0xFFFF21E1);
		}
		if (curSong.toLowerCase() == 'bell-buster-duo')
		{
		healthBar.createFilledBar(0xFFFF0000, 0xFFFF21E1);
		}
		// healthBar
	...
	if (curSong.toLowerCase() == 'bell-buster' || curSong.toLowerCase() == 'bell-buster-duo')
	{
	...
	function schoolIntro(?dialogueBox:DialogueBox):Void
	{
		...
		if (SONG.song.toLowerCase() == 'roses' || SONG.song.toLowerCase() == 'thorns' || SONG.song.toLowerCase() == 'jester' || SONG.song.toLowerCase() == 'bell-buster')
		{
			remove(black);
	...
	*/
	...
	override function beatHit()
	{
		...
		{
			case 'circus-rally':
				stageSeat1People.animation.play('bop', true);
				stageSeat2People.animation.play('bop', true);

			case 'circus-peak':
				stageSeat1People.animation.play('bop', true);
				stageSeat2People.animation.play('bop', true);
				stageSeat3People.animation.play('bop', true);
