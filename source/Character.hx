	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				playAnim('idle');
			case 'jester':
				tex = Paths.getSparrowAtlas('Jester','week7');
				frames = tex;
				animation.addByPrefix('idle', "JESTER_IDLE", 24);
				animation.addByPrefix('singUP', 'JESTER_UP', 24, false);
				animation.addByPrefix('singDOWN', 'JESTER_DOWN', 24, false);
				animation.addByPrefix('singLEFT', 'JESTER_LEFT', 24);
				animation.addByPrefix('singRIGHT', 'JESTER_RIGHT', 24);

				addOffset('idle', 0, 90);
				addOffset("singUP", 0, 100);
				addOffset("singRIGHT", -13, 57);
				addOffset("singLEFT", 10, 54);
				addOffset("singDOWN", 0, 22);

				playAnim('idle');
			case 'jester-duo':
				tex = Paths.getSparrowAtlas('Jester','week8');
				frames = tex;
				animation.addByPrefix('idle', "JESTER_IDLE", 24);
				animation.addByPrefix('singUP', 'JESTER_UP', 24, false);
				animation.addByPrefix('singDOWN', 'JESTER_DOWN', 24, false);
				...
				playAnim('idle');
			case 'jester-old':
				tex = Paths.getSparrowAtlas('oldJester','week7');
				frames = tex;
				animation.addByPrefix('idle', "oldJESTER1 Idle", 24);
				animation.addByPrefix('singUP', 'oldJESTER1 Up', 24, false);
				animation.addByPrefix('singDOWN', 'oldJESTER1 Down', 24, false);
				animation.addByPrefix('singLEFT', 'oldJESTER1 Left', 24);
				animation.addByPrefix('singRIGHT', 'oldJESTER1 Right', 24);
